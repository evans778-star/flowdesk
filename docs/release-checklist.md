...
- Tag name, for example `v0.1.0-beta`.
- Release title.
- Highlights.
- Known limitations.
...
Flowdesk `v0.1.0-beta` is a demo/template release. Do not describe it as production-ready until RBAC, rate limiting, monitoring, backup, and production storage are implemented and verified.
